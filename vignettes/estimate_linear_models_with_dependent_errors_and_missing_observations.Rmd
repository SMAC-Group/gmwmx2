...
We then obtain $\boldsymbol{\vartheta}$, the estimated parameters of the missingness process using the maximum likelihood estimator, assuming a two-state Markov model.
