...
\(Z_i = 1\) indicating an observation and \(Z_i = 0\) a missing observation
for $i \in \{1,\ldots, n\}$. The missingness process is independent of
...
likelihood, assuming a two-state Markov model.
